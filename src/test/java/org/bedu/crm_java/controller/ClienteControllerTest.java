...
class ClienteControllerTest {
    ...
    void getCliente() throws Exception {
        given(clienteService.obtenerCliente(anyLong())).willReturn(Optional.of(Cliente.builder().id(1L).nombre("Nombre").correoContacto("cliente@contacto.com").build()));
    ...
    void getClientes() throws Exception {
        ...
        given(clienteService.obtenerClientes()).willReturn(clientes);
    ...
    void creaCliente() throws Exception {
        ...
        given(clienteService.guardarCliente(clienteParametro)).willReturn(clienteRespuesta);
